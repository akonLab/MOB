...
export class MatrixMultiplier extends Component {
    data = {
                    ...
                    <div className="col-12 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body">
                                <h4 className="card-title">Проследить эффект матричного мультипликатора</h4>
                                <p className="card-description">
                                    при дополнительном увеличении конечного продукта по какой-либо отрасли на X %.
                                </p>

                                <form className="forms-sample">

                                    <Form.Group>
                                        <label htmlFor="inputIndustry">Введите номер отрасли например: 1</label>
                                        <Form.Control type="text" id="inputIndustry" placeholder="Отрасль" size="lg" />
                                    </Form.Group>

                                    <Form.Group>
                                        <label htmlFor="inputPercent">Сколько процентов увеличении, введите процент, например: 7</label>
                                        <Form.Control type="text" id="inputPercent" placeholder="Процентное увеличение" size="lg" />
                                    </Form.Group>
...
<div>
    <label htmlFor="inputIndustry">Введите номер отрасли например: 1</label>
    <input type="text" id="inputIndustry" placeholder="Отрасль" size="lg" />
</div>

<div>
    <label htmlFor="inputPercent">Сколько процентов увеличении, введите процент, например: 7</label>
    <input type="text" id="inputPercent" placeholder="Процентное увеличение" size="lg" />
</div>

<div>
    <label>Выберите таблицу</label>
    <div className="custom-file">
        <input type="file" className="form-control visibility-hidden" id="customFileLang" lang="es" />
        <label className="custom-file-label" htmlFor="customFileLang">Upload table</label>
    </div>
</div>
</form> */}
